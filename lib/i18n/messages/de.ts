...
export const DE_MESSAGES: UiMessages = {
  ...
  home: {
    ...
    closingLead: "Kostenlos mit einer Deutung starten. Abonnieren fürs Tagebuch und weitere KI-Lesungen.",
    faqs: [
      {
  ...
  dictionary: {
    ...
    dreamTextTitle: "Das klingt nach einem ganzen Traum",
    dreamTextLead: "Das Wörterbuch sucht einzelne Symbole. Lass dir diesen Traum stattdessen von der KI deuten.",
    dreamTextCta: "Diesen Traum deuten",
    noMatchAsk: "KI zu „{query}“ fragen",
    dreamTextPanelLabel: "Traumdeutung aus der Wörterbuchsuche",
    dreamTextClose: "Schließen",
  ...
  legal: {
    ...
    refundShort: "Erstattung",
    pricingShort: "Preise",
    checkoutPrefix: "Mit der Zahlung akzeptieren Sie die",
    checkoutAnd: "und die",
  },
  pricing: {
    h1: "Preise",
    lead: "Starte mit einer kostenlosen Deutung. Danach abonnieren für Tagebuch und KI-Lesungen.",
    plansTitle: "Pläne",
    monthly: "Monatlich",
    yearly: "Jährlich",
    free: "Kostenlos",
    ...
    seoDescription:
      "Dreamly abonnieren für KI-Traumdeutungen: 6,99 USD/Monat oder 69,99 USD/Jahr mit 3 Tagen Test. Erste Deutung, Lexikon und Galerie bleiben kostenlos.",
    subscribeCta: "Abonnieren",
    cancelAnytime: "Jederzeit im Profil kündigen.",
  ...
  upgrade: {
    ...
    signInFirst: "Bitte zuerst anmelden, dann zurückkommen zum Abonnieren.",
    goSignIn: "Zur Anmeldung",
    success: "Abo aktiv. Deine 3-tägige Testphase hat begonnen.",
    cancelled: "Abo gekündigt. Der Zugang bleibt bis zum Periodenende.",
    creating: "PayPal wird geöffnet…",
    paying: "Abo wird aktiviert…",
    continueWithout: "Ohne Abo fortfahren",
    paypalMissing: "PayPal ist nicht konfiguriert.",
  ...
  profile: {
    ...
    signInHint: "Oben in der Leiste anmelden",
  },
  chrome: {
    home: "Start",
    pages: "Seiten",
