...
export const EN_MESSAGES: UiMessages = {
  ...
  pricing: {
    h1: "Pricing",
    lead: "Dreamly is free to start. Optional credit packs buy extra AI dream interpretations.",
    packsTitle: "Credit packs",
    credits: "{n} credits",
    oneTime: "One-time purchase · digital credits",
    useFor: "Use credits to save and interpret dreams in the app.",
    freeNote: "The dream journal, full dictionary, gallery, and your first interpretation stay free.",
    refundNote: "30-day money-back guarantee. See the Refund Policy.",
    seoTitle: "Dreamly Pricing — Optional AI Dream Interpretation Credits",
    seoDescription:
      "Optional credit packs for extra AI dream interpretations. Journal, dictionary, and first interpretation are free. 30-day money-back guarantee.",
  },
  chrome: {
    home: "Home",
    pages: "pages",
