...
export const EN_MESSAGES: UiMessages = {
  ...
  dictionary: {
    ...
    dreamTextTitle: "Looks like a whole dream",
    dreamTextLead: "The dictionary looks up single symbols. Get an AI interpretation of this dream instead.",
    dreamTextCta: "Interpret this dream",
    noMatchAsk: "Ask AI about “{query}”",
    dreamTextPanelLabel: "Interpreting a dream from the dictionary search",
    dreamTextClose: "Close",
  ...
  chrome: {
    ...
    watchVideoMinutes: "Watch the {minutes}-min video",
