...
export const ES_MESSAGES: UiMessages = {
  ...
  dictionary: {
    ...
    dreamTextTitle: "Parece un sueño completo",
    dreamTextLead: "El diccionario busca símbolos sueltos. Mejor pide a la IA una interpretación de este sueño.",
    dreamTextCta: "Interpretar este sueño",
    noMatchAsk: "Preguntar a la IA: «{query}»",
    dreamTextPanelLabel: "Interpretación de un sueño desde la búsqueda del diccionario",
    dreamTextClose: "Cerrar",
  ...
  chrome: {
    ...
    watchVideoMinutes: "Ver el video de {minutes} min",
