...
const RU: Record<DreamCategory, CategoryCopy> = {
  animals: { label: "Сны о животных", description: "Инстинкт, доверие, границы, защита и та часть нас, что не поддаётся приручению." },
  body: { label: "Сны о теле", description: "Уверенность в себе, здоровье, самовыражение, самоощущение и контроль над собой." },
  water: { label: "Сны о воде", description: "Чувства, интуиция, перемены, очищение и всё, что движется под поверхностью сознания." },
  "life-events": { label: "Сны о событиях жизни", description: "Начала и концы, ответственность, близость, ценности и переходы." },
  "fear-nightmares": { label: "Страх и кошмары", description: "Давление, избегание, неуверенность, уязвимость и потребность в безопасности." },
  places: { label: "Сны о местах", description: "Принадлежность, память, внутренняя опора, личное пространство и эмоциональный фундамент." },
  movement: { label: "Сны о движении", description: "Свобода, направление, амбиции, контроль, движение вперёд и смена точки зрения." },
  objects: { label: "Сны о вещах и ценностях", description: "Безопасность, возможности, самооценка, ресурсы и практические приоритеты." },
  people: { label: "Сны о людях и отношениях", description: "Любовь, семья, привязанность, предательство, тоска и связи, которые формируют наше «я»." },
  nature: { label: "Сны о природе и стихии", description: "Стихия, перелом, обновление и то, что больше нашего контроля." },
  spiritual: { label: "Духовные и сверхъестественные сны", description: "Вера, невидимое, защита, страх перед запредельным и вести изнутри." },
};
