...
const FAITH: Record<Locale, Record<FaithSlug, FaithCopy>> = {
  ...
  ru: {
    biblical: {
      ...
      perspectiveLabel: "Библейское толкование",
      seoTitle: "Библейское толкование снов: Писание и надежда",
      seoDescription:
        "Сны о змее, воде, смерти, огне и свадьбе в свете Писания: мудрость и надежда, а не готовый ключ к каждому образу.",
      intro: [
        "В Писании некоторые сны значимы — снопы Иосифа, коровы фараона, предупреждение волхвам, — но нигде не сказано, что всякий сон есть весть свыше. Поэтому библейский взгляд на сегодняшний сон осторожен: образ сверяют с темами Писания, с обстоятельствами жизни, с молитвой и мудрым советом, а не принимают за личное пророчество.",
        "У каждого символа есть полное библейское размышление рядом с психологическим, духовным и исламским толкованием, чтобы один и тот же сон можно было рассмотреть с нескольких сторон, прежде чем делать выводы.",
      ],
    },
    islamic: {
      heading: "Исламские значения снов",
      perspectiveLabel: "Исламское толкование",
      seoTitle: "Исламское толкование снов: символы и значения",
      seoDescription:
        "Сны о змее, воде, зубах, огне и браке в исламской традиции — спокойно и без превращения образа в приговор.",
      intro: [
        "Исламская традиция различает три рода снов: благие видения, сны, рождённые из собственных мыслей и дневных забот, и тягостные сны. Толкуют их со смирением: сон не даёт достоверного знания о сокрытом, не служит уликой против другого человека, и делятся им только с тем, кому доверяют.",
        "У каждого символа есть полное исламское размышление рядом с психологическим, духовным и библейским толкованием, чтобы разбор сна успокаивал, а не пугал.",
      ],
    },
    spiritual: {
      heading: "Духовные значения снов",
      perspectiveLabel: "Духовное толкование",
      seoTitle: "Духовное толкование снов: рост и внимание",
      seoDescription:
        "Сны о змее, воде, ангелах, огне и смерти как приглашение к размышлению, а не предсказание того, что случится.",
      intro: [
        "Духовное толкование спрашивает не «что будет», а «какое качество сейчас просит воспитать в себе этот период жизни». Терпение, смелость, умение отпускать, защита своих границ, благодарность, рассудительность — яркий образ часто указывает на то, чего из этого не хватает.",
        "У каждого символа есть полное духовное размышление рядом с психологическим, исламским и библейским толкованием, чтобы разбор сна углублял внимание к себе, а не множил страх.",
      ],
    },
  },
  ar: {
